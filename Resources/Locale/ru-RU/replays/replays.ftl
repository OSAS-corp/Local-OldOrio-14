...
cmd-replay-toggle-screenshot-mode-desc = Переключает режим создания скриншотов при просмотре повтора.
cmd-replay-toggle-screenshot-mode-help = Использование: replay_toggle_screenshot_mode
