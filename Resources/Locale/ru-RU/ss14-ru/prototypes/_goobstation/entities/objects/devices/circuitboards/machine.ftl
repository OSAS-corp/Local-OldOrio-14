...
ent-InteractorCircuitboard = исполнитель (машинная плата)
    ...
    .suffix = { ent-BaseMachineCircuitboard.suffix }
ent-ServiceEnergyChemMachineCircuitboard = энергетический синтезатор еды (машинная плата)
    .desc = Печатная плата энергетического синтезатора еды.
    .suffix = { ent-BaseMachineCircuitboard.suffix }
ent-EnergyBoozeDispenserMachineCircuitboard = энергетический раздатчик алкоголя (машинная плата)
    .desc = Печатная плата энергетического раздатчика алкоголя.
    .suffix = { ent-BaseMachineCircuitboard.suffix }
ent-EnergySodaDispenserMachineCircuitboard = энергетический раздатчик безалкоголя (машинная плата)
    .desc = Печатная плата энергетического раздатчика безалкоголя.
    .suffix = { ent-BaseMachineCircuitboard.suffix }
