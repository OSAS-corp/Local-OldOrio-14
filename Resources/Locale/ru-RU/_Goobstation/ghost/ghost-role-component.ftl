...
ghost-role-information-tunnel-clown-description = Член клоунской банды, обитающий только в тех. тоннелях и может объявить их своей территорией. Он должен не давать посторонним лицам проникать на свою территорию и добиваться их ухода при необходимости используя стан-палку или топор, но не убивая тех, кто не нёс вам угрозы, дабы не потерять разрешение ЦК.
ghost-role-information-tunnel-clown-rules = Техклоун - это малый антагонист, обитающий только в тех. тоннелях и может объявить их своей территорией. Он должен не давать посторонним лицам проникать на свою территорию и добиваться их ухода при необходимости используя стан-палку или топор. Убийство за сам факт нахождения в тех. тоннелях - запрещен. Летальная сила допустима только при непосредственной угрозе жизни.
tunnel-clown-role-greeting = Вы — [color=#880808]Тех-клоун[/color] - это малый антагонист, обитающий только в тех. тоннелях и может объявить их своей территорией. Он должен не давать посторонним лицам проникать на свою территорию и добиваться их ухода при необходимости используя стан-палку или топор. Убийство за сам факт нахождения в тех. тоннелях - запрещен. Летальная сила допустима только при непосредственной угрозе жизни. Ознакомьтесь с панелью персонажа, чтобы узнать свои цели.
