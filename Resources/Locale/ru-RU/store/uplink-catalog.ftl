...
uplink-buldog-bundle-name = Набор "Бульдог 2.0"
...
uplink-energycrossbow-name = Миниатюрный энергетический арбалет
uplink-energycrossbow-desc = Энергетический арбалет синдиката, запускающий возобновляемые токсичные снаряды, способные мгновенно поражать цели.
