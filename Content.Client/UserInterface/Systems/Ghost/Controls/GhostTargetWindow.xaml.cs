...
namespace Content.Client.UserInterface.Systems.Ghost.Controls
{
    ...
    public sealed partial class GhostTargetWindow : DefaultWindow
    {
        ...
        */
        ...
        private SpriteSystem Sprite => _sprite ??= _entitySystem.GetEntitySystem<SpriteSystem>();
        // Arcane-End
            ...
            foreach (var departmentList in sortedPlayers)
            {
                ...
                foreach (var player in departmentList)
                {
                    var playerButton = new Button
                    {
                        ...
                        TooltipDelay = 0.1f,
                        SetWidth = 180,
                        // ClipText = true, // Arcane-Edit
                    };

                    playerButton.OnPressed += _ => WarpClicked?.Invoke(player.Entity);

                    // Arcane-Start
                    var playerRow = new BoxContainer
                    {
                        Orientation = BoxContainer.LayoutOrientation.Horizontal,
                        HorizontalExpand = true,
                    };

                    if (_prototypeManager.TryIndex<JobIconPrototype>(player.JobIcon, out var jobIcon))
                    {
                        playerRow.AddChild(new TextureRect
                        {
                    ...
                    playerButton.AddChild(playerRow);
                    // Arcane-End
